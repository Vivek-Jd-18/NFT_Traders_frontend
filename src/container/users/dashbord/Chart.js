    ...
    constructor(props) {
        ...
        this.state = {
            ...
            options: {
                ...
                xaxis: {
                    categories: ['11 Sep, 2022', '11 Sep, 2022', '11 Sep, 2022', '11 Sep, 2022', '11 Sep, 2022', '11 Sep, 2022', '11 Sep, 2022'],
                    labels: {
                        show: false
                    },
                    title: {
                ...
                tooltip: {
                    ...
                    custom: function ({ series, seriesIndex, dataPointIndex, w }) {
                       ...
                       <span style="color:#FC414D;font-weight: bold;">430Eth</span>
                       <span style="font-weight: bold;color:#6C6C6C;">Spent</span>
                       ...
                       border-radius: 50%;
                       display: inline-block;"></span>
                       <span style="color:#2CBC20;font-weight: bold;">430Eth</span>
                       <span style="font-weight: bold;color:#6C6C6C;">Portfolio Value</span>
                       <span style='font-size:23px;color:#0EB700;'>&#8593;</span>
                       <span style='color:#0EB700;'>12%</span>
